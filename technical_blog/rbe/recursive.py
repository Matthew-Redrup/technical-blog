...
# %% auto 0
__all__ = ['prior', 'evidence_sequence', 'likelihoods', 'belief_evolution', 'security_transitions', 'markov_result', 'fig',
           'axes', 'perf_results', 'long_evidence', 'long_likelihoods', 'memory_results', 'baseline', 'traffic_data',
           'monitoring_results', 'attack_patterns', 'event_sequence', 'attack_results', 'detected_patterns',
